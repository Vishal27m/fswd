    ...
    <div className="town-article-container">
      <div className="town-content">
        <div className="article-text">
          <h1 className="town-title">{article.title}</h1>
          <p>{article.description}</p>

          <h2>Etymology</h2>
          <p>{article.etymology}</p>

          <h2>Economy</h2>
          <p>{article.economy}</p>

          <h2>Geography</h2>
          <p>{article.geography}</p>

          <h2>Demographics</h2>
          <p>{article.demographics}</p>
...
export default UserTownArticle1;
